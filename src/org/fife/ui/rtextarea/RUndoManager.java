 ...
 * @version 1.0
 */
public class RUndoManager extends UndoManager implements KeyListener {
	...
	private boolean newline_was_created = false;
	...
	public void undoableEditHappened(UndoableEditEvent e) {
		...
		// grouped together.
		System.out.println(newline_was_created);
		if (Math.abs(diff)<=1 && !newline_was_created) {//==1) {
			compoundEdit.addEdit(e.getEdit());
			lastOffset += diff;
			newline_was_created = false;
			//updateActions();
